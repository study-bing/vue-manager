<template>
  <div class="scenicList" ref="contents">
    <div class="search-content">
      ...
      <el-button type="primary" class="pull-right" @click="addScenic">添加景区</el-button>
    </div>
    <el-table :data="tableData" border :height="tableHeight" v-if="tableHeight > 0">
      <el-table-column type="index" width="60" label="序号"></el-table-column>
      <el-table-column prop="date1" label="类型"></el-table-column>
      <el-table-column prop="date2" label="景区编号"></el-table-column>
      <el-table-column prop="name" label="景区名称"></el-table-column>
      <el-table-column prop="tel" label="电话"></el-table-column>
      <el-table-column prop="address" label="地址" min-width="150"></el-table-column>
      <el-table-column prop="tel" label="添加人"></el-table-column>
      <el-table-column prop="tel" label="添加时间"></el-table-column>
    ...
    ></el-pagination>
    <scenic-set :dialogVisible.sync="showSet" @closeDialog="closeDialog"></scenic-set>
  </div>
</template>
<script>
import tableMixin from '@mixin/tableMixin';
import scenicSet from './ScenicSet';
export default {
	name: 'scenicList',
	data() {
		return {
