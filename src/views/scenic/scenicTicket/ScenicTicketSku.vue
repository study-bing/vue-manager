<template>
  <div class="scenicTicketSku" ref="contents">
    ...
    <el-table :data="tableData" border :height="tableHeight" v-if="tableHeight > 0">
      ...
      <el-table-column prop="date1" label="门票编号"></el-table-column>
      <el-table-column prop="date2" label="所属景区"></el-table-column>
      <el-table-column prop="name" label="门票名称"></el-table-column>
      <el-table-column prop="tel" label="价格"></el-table-column>
      <el-table-column prop="address" label="已售数量" min-width="150"></el-table-column>
    ...
    ></el-pagination>
    <sku-set :dialogVisible.sync="showSet" @closeDialog="closeDialog"></sku-set>
  </div>
</template>
<script>
import tableMixin from '@mixin/tableMixin';
import skuSet from './ScenicTicketSkuSet';
export default {
	name: 'scenicTicketSku',
	data() {
		return {
			tableData: [
				{
